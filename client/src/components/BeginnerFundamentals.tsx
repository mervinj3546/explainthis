          ...
          <CardContent>
            ...
            <div className="mt-6 pt-6 border-t border-border">
              <div className="flex justify-center">
                <div className="text-center">
                  <div className="text-muted-foreground text-sm mb-2">Overall Financial Health</div>
          ...
          <Card className="bg-gradient-to-b from-[#1E2227] to-[#181B20] border-[#2A2F36] shadow-[0_4px_12px_rgba(0,0,0,0.3)]">
            ...
            <CardContent>
              ...
              <div className="mt-6 pt-6 border-t border-border">
                <div className="flex justify-center">
                  <div className="text-center">
                    <div className="text-muted-foreground text-sm mb-2">Dividend Quality Assessment</div>
                    <Badge variant="outline" className={`${
                      (apiData?.dividend?.dividendYield || 0) >= 2 && 
                      (apiData?.dividend?.payoutRatio || 0) < 60 && 
                      (apiData?.dividend?.dividendGrowth5Y || 0) > 0 
                        ? 'text-bullish border-bullish' 
                        : (apiData?.dividend?.dividendYield || 0) >= 1 && 
